...
lib.ssMetadata = [
		{name:"Legion_5a_15AHP11_CM_GDN_160x600_atlas_1", frames: [[1134,0,50,50],[0,0,160,600],[162,0,160,600],[324,0,160,600],[486,0,160,600],[648,0,160,600],[810,0,160,600],[972,0,160,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Legion_5a_15AHP11_CM_GDN_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Legion5a15AHP11CMGDN160x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(241).to({_off:false},0).to({_off:true},59).wait(110));

	// Layer_4
	this.instance_3 = new lib.Frame4();
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(181).to({_off:false},0).to({_off:true},60).wait(169));
...
// library properties:
lib.properties = {
	id: 'FCC76505025EBE4F972B0A0C43ADC1BD',
	width: 160,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Legion_5a_15AHP11_CM_GDN_160x600_atlas_1.png", id:"Legion_5a_15AHP11_CM_GDN_160x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['FCC76505025EBE4F972B0A0C43ADC1BD'] = {
